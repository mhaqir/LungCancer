...
d <- h5read('GDC_BMR_samples_mutations.h5', '/GDC_BMR_samples_mutations')
# d <- h5read('GDC_samples_mutations.h5', '/GDC_samples_mutations')

# clinical_GDC <- read.table('GDC_samples.txt', header = TRUE, sep = '	')
...
pdf(file = sprintf('plots/GDC_BMR_tree1_%s.pdf', lo), width = 20, height = 25)
